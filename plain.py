...
# jawne podanie modelu i frameworka (używamy lokalnie pobranego modelu lub nazwy modelu)
# ustaw framework na 'pt' (PyTorch) lub 'tf' (TensorFlow) w zależności od instalacji
fw = "pt"
